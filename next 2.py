...
def menu_apikey():
  ...
  print("""\x1b[1;97m
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : MD HRIDOY KHAN            │
    │ [✓] GITHUB   : HRIDOY.XXX                │
    │ [✓] WHATSAPP : +8801838873419         │
    │ [✓] VERSION  : XNXX                   │
  ...
  try:
    httpCaht = requests.get("https://github.com/S3X-XD4/next/blob/main/Apt.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open https://wa.me/+88010838873419?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
